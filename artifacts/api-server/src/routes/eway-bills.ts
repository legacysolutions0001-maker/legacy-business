...
router.get("/eway-bills", requireAuth, async (req, res) => {
...
router.post("/eway-bills", requireAuth, async (req, res) => {
  const companyId = req.auth!.companyId;
  if (!companyId) { res.status(403).json({ error: "Company required" }); return; }
  const data = req.body;
...
router.get("/eway-bills/:id", requireAuth, async (req, res) => {
  const companyId = req.auth!.companyId;
...
router.patch("/eway-bills/:id", requireAuth, async (req, res) => {
  const companyId = req.auth!.companyId;
...
router.delete("/eway-bills/:id", requireAuth, async (req, res) => {
  const companyId = req.auth!.companyId;
...
router.post("/eway-bills/:id/generate-nic", requireAuth, async (req, res) => {
  const companyId = req.auth!.companyId;
