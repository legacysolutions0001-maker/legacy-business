...
function AppRoutes() {
  return (
    <Switch>
      ...
      <Route path="/crm"><CompanyRoute component={CRM} /></Route>
      <Route path="/appointments"><CompanyRoute component={Appointments} /></Route>
      <Route path="/expenses"><CompanyRoute component={Expenses} /></Route>
      <Route path="/projects"><CompanyRoute component={Projects} /></Route>
